...
export const ALL_BOOKS = (name = "react") =>
  `${BASE_URL}fields=totalItems,items/id,items/volumeInfo(title,categories,authors,description,imageLinks)&q=${name}&startIndex=${startNum}&maxResults=${maxNum}&key=${keyAPI}`;
